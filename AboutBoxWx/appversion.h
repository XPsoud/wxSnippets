...
#define VERSION_BUILD   80118

#define PRODUCTNAME "AboutBoxWx"
#define DESCRIPTION "wxWidgets provided AboutBox"
#define wDESCRIPTION _("wxWidgets provided AboutBox")
