...
#define VERSION_BUILD   80424

#define PRODUCTNAME "AutoComplete"
#define DESCRIPTION "wxWidgets TextCtrl autocomplete test"
#define wDESCRIPTION _("wxWidgets TextCtrl autocomplete test")
