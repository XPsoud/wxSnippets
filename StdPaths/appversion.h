...
#define VERSION_BUILD   70921

#define PRODUCTNAME "wxStandardPaths"
#define DESCRIPTION "wxStandardPaths Application"
#define wDESCRIPTION _("wxStandardPaths Application")
